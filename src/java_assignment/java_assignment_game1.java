...
public class java_assignment_game1 {
	
	private static Random random, random2;
	private static int ch, cw, e1h, e1w, dot, locate, em1, em2, point, e2w, e2h, locate2, gamecount, ch2, cw2;
	...
	private static int seat1, seat2, seat3, seat4, seat5, life2;

	public java_assignment_game1() {
		...
		dot=180; point=0;
		em1=3; em2=1; 
		enemylocate=black; enemylocate2=black;
		life2=4; gamecount=0;
		...
		Timer t = new Timer(100, enemymove1);
		t.start();
		...
		Timer k = new Timer(100, enemymove2);
		k.start();
		...
		map[18][11].setIcon(dotpoint); map[18][12].setIcon(dotpoint); map[18][13].setIcon(dotpoint); map[18][15].setIcon(dotpoint); map[18][17].setIcon(dotpoint); 
					...
					Timer t = new Timer(75, enemymove1);
					Timer k = new Timer(75, enemymove2);
					t.start();
					k.start();
					}
					break;
		...
		map[18][11].setIcon(dotpoint); map[18][12].setIcon(dotpoint); map[18][13].setIcon(dotpoint); map[18][15].setIcon(dotpoint); map[18][17].setIcon(dotpoint); 
					...
					gamecount = gamecount+1;
					Timer t = new Timer(50, enemymove1);
					Timer k = new Timer(50, enemymove2);
					t.start();
					k.start();
					}
					break;
				...
				String kk = name1.getText();
				 ...
				 Connection conn = null; 
			        ...
			        try {
			            ...
			            String quary = "update guser set point2 = "+point+" where name = '"+k+"' ";
			            String quary2 = "select point2 from guser where name = '"+k+"' ";
