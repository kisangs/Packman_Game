...
public class java_assignment_hiddenMap4 extends JFrame implements KeyListener {
	JLabel yball = new JLabel(new ImageIcon("imgage/characterleft1"));
	public java_assignment_hiddenMap4() {
		...
		final ImageIcon hiddmap = new ImageIcon("image/hiddmap_fin.png");
