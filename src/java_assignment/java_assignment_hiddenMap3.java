...
public class java_assignment_hiddenMap3 extends JFrame implements KeyListener {
	JLabel yball = new JLabel(new ImageIcon("imgage/characterleft1"));
	public java_assignment_hiddenMap3() {
		...
		final ImageIcon hiddmap = new ImageIcon("image/hiddmap_3.png");
	...
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_CONTROL:
			if(yball.getX() == 569 && (yball.getY()>=380 && yball.getY()<=470)) {
				new java_assignment_hiddenMap4();
...
//	}
		...
		public static void main(String[] args) {
			new java_assignment_hiddenMap3();
		}
	@Override
	public void keyPressed(KeyEvent e) {
