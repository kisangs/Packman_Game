...
public class java_assignment_hiddenMap2 extends JFrame implements KeyListener {
	JLabel yball = new JLabel(new ImageIcon("imgage/characterleft1"));
	public java_assignment_hiddenMap2() {
		...
		final ImageIcon hiddmap = new ImageIcon("image/hiddmap_2.png");
